"""Integration tests for accumulate with different configurations."""
...
class TestMakeForceGridConfigurations:
    """Test accumulate with different density/rigid/centre configurations."""
    ...
    def test_polarisation_single_species_raises(self, ts_single_species):
        ...
        with pytest.raises(ValueError, match="single atom"):
            gs.accumulate(ts_single_species, atom_names="H", rigid=True, centre_location=True)
    ...
    def test_rigid_invalid_centre_location_raises(self, ts_multi_species):
        ...
        with pytest.raises(ValueError, match="centre_location"):
            gs.accumulate(ts_multi_species, atom_names=["H", "O"], rigid=True, centre_location="invalid")
